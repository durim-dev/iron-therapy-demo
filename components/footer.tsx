    ...
    <footer className="bg-secondary border-t border-border py-16">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          {/* Navigation */}
          <div>
            <p className="text-xs uppercase tracking-[0.3em] text-muted-foreground mb-4 font-semibold">
              Navigation
            </p>
            <nav className="flex flex-col gap-3">
              <a href="#angebot" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                Angebot
              </a>
              <a href="#ueber-uns" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                {"\u00dcber Uns"}
              </a>
              <a href="#equipment" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                Equipment
              </a>
              <a href="#kontakt" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                Kontakt
              </a>
            </nav>
          </div>
